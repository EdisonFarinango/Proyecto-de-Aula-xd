...
public class ProductosCat {
    ...
    public static void llenarComboCamisetas(JComboBox<String> comboBox) {
        ...
        try {
            // Llamar al procedimiento almacenado
            CallableStatement stmt = conexion.conn.prepareCall("{call ObtenerCamisas()}");
            rs = stmt.executeQuery();
    ...
    public static void llenarComboTallasCamisas(JComboBox<String> comboBox, String nombreProducto) {
        ConexionBD conexion = new ConexionBD();
        ResultSet rs = null;
    ...
    public static int obtenerStockDisponibleCamisas(String producto, String talla) {
        int stock = 0;
        ConexionBD conexion = new ConexionBD();
        ResultSet rs = null;
    ...
    public static double obtenerPrecioCamisas(String producto, String talla) {
        double precio = 0.0;
        ConexionBD conexion = new ConexionBD();
        ResultSet rs = null;
        CallableStatement stmt = null;
