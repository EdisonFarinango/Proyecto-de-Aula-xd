...
public class Pantalones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("COMPRAR PANTALONES");
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 82, -1, -1));
        ...
        jPanel1.add(spinnerCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 106, 32));
        ...
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(btnAñadirTabla, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE)
        );
        ...
        if (tablaPantalones.getColumnModel().getColumnCount() > 0) {
            tablaPantalones.getColumnModel().getColumn(0).setResizable(false);
            tablaPantalones.getColumnModel().getColumn(1).setResizable(false);
            tablaPantalones.getColumnModel().getColumn(2).setResizable(false);
            tablaPantalones.getColumnModel().getColumn(3).setResizable(false);
            tablaPantalones.getColumnModel().getColumn(4).setResizable(false);
        }

        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 488, 270));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Imagen del Pantalón", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Roboto Black", 0, 18))); // NOI18N
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblImagen, javax.swing.GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
                .addContainerGap())
        );
...
// Crear una nueva instancia de Carrito
    ...
    private void validarStock() {
        ...
        if (productoSeleccionado != null && tallaSeleccionada != null) {
            ...
            // Validar si la cantidad ingresada excede el stock disponible
            if (cantidadIngresada > stockDisponible) {
                // Ajustar el valor del spinner a la cantidad máxima permitida
