...
public class Camisetas extends javax.swing.JFrame {
    ...
    public Camisetas() {
        ...
        ProductosCat.llenarComboCamisetas(comboProductos);
    ...
    private void mostrarImagen() throws IOException {
        ...
        if (productoSeleccionado != null) {
            ...
            String imagePath = "C:/Users/USER/OneDrive/Escritorio/ProyectoAula/imgs/Camisas/";
            File imageFile = null;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("COMPRAR CAMISAS");
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 480, 270));

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Imagen de Camisa", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Roboto Black", 0, 24))); // NOI18N
    ...
    private void comboProductosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboProductosItemStateChanged
        if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
            ...
            if (productoSeleccionado != null) {
                ProductosCat.llenarComboTallasCamisas(comboTallas, productoSeleccionado);
            }
        }
    ...
    private void btnAñadirTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAñadirTablaMouseClicked
        ...
        if (productoSeleccionado != null && tallaSeleccionada != null) {
            if (cantidadIngresada > 0) { // Validar que la cantidad sea mayor que 0
                double precio = ProductosCat.obtenerPrecioCamisas(productoSeleccionado, tallaSeleccionada);
                int stockDisponible = ProductosCat.obtenerStockDisponibleCamisas(productoSeleccionado, tallaSeleccionada);
